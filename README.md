...
Check out the [[**Project Page**](https://andreaslh.github.io/Weak-Cube-R-CNN-project-page/)] [[**HuggingFace 🤗 demo**](https://huggingface.co/spaces/AndreasLH/Weak-Cube-RCNN)], Download the model on [**HuggingFace 🤗**](https://huggingface.co/AndreasLH/Weak-Cube-R-CNN), 

[Paper is now on Arxiv](https://arxiv.org/abs/2504.13297)
```bib
